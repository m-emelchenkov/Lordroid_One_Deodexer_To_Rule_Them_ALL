...
public class ApkWorker implements Runnable {
	...
	public ApkWorker(ArrayList<File> apkFoldersList, LoggerPan logPan, File tmpFolder , boolean doSign ,boolean doZipalign) {
...
//
//		if(!deodexed){
//			logPan.addLog(R.getString(S.LOG_INFO) + " [" + apk.getOrigApk().getName() + "]"
...
//		// make sure there is no libs in that folder before deleting it (bootloops are no tolerated ! )
//		for( File f : files){
