...
public class LinksPan extends JPanel {
	...
	public LinksPan(){
		...
		JButton xdaThread = new JButton(R.getString("0000114"));
		JButton github = new JButton(R.getString("0000115"));
		JButton reportBug = new JButton(R.getString("0000116"));
		JButton reportBugXda = new JButton(R.getString("0000117"));
		JButton writeReview = new JButton(R.getString("0000118"));
		JButton requesteFeature = new JButton(R.getString("0000119"));
		JButton githubRelease = new JButton(R.getString("0000120"));
		JButton eMailDev = new JButton(R.getString("0000121"));
